...
function jara_tm_modalbox_news(){
	...
	button.on('click',function(){
		...
		modalBox.find('.news_popup_informations').prepend('<div class="image"><img src="html/jara/img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
...
function jara_tm_modalbox_portfolio(){
	...
	button.on('click',function(){
		...
		modalBox.find('.popup_details').prepend('<div class="top_image"><img src="html/jara/img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
